      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          >
            <FontAwesomeIcon
              icon={faShop}
              className="text-pink-500 text-3xl group-hover:rotate-12 transition-transform duration-300"
            />
          ...
          <nav className="hidden md:flex items-center gap-8 font-medium">
            {[
              ...
              <button
                ...
                className="relative text-gray-700 hover:text-pink-600 transition-colors duration-300 after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-gradient-to-r after:from-pink-500 after:to-rose-400 hover:after:w-full after:transition-all after:duration-300"
              >
                {item.label}
              </button>
            ))}
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="text-pink-500 hover:text-rose-500 p-2 transition-transform hover:scale-110"
            >
