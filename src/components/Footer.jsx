      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <FontAwesomeIcon icon={faShop} className="text-pink-500 text-xl" />
          ...
          <div className="text-center md:text-left">
            <p className="text-gray-600 text-sm">
              Made with{" "}
              <FontAwesomeIcon icon={faHeart} className="text-pink-500" /> for
          ...
          <nav className="flex gap-6" aria-label="Footer navigation">
            <a
              href="#about"
              className="text-gray-600 hover:text-pink-500 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 rounded px-2 py-1"
            >
              About
            </a>
            <a
